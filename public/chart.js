...
(function() {
  //### templates
  var BeamWeaponData, CRIT, CircleHitBox, Enemy, HIT, HOG_HP, HitBox, MISS, PhotonProjectorWeaponData, RectHitBox, WeaponData, areascale, basicCursorHeight, chart, chart_padding_left, chart_padding_right, chart_width, crosshair, enemy, enemy_Roadhog, formatNumber, hero_filter, hero_rows, hero_selection_template, hero_weapon_template, htmlToElement, info_string, max_time, multiplier, radians, row_template, state_data, timeAxis, timeScale, timescale;
  ...
  WeaponData = (function() {
    ...
    class WeaponData {
      ...
      init_shots() {
        var ammo, ammo_consumed, dt, shot, t, total_dmg;
        t = 0;
        this.shots = [];
        ...
        return console.log(this.weapon.name, this.shots.length);
      }
  ...
  PhotonProjectorWeaponData = class PhotonProjectorWeaponData extends BeamWeaponData {
    calculate_shots_damage() {
      var basic_dmg, dmg, factor, h, index, j, k, last_shot, len, len1, ref, ref1, shot, time, total_dmg;
      this.height = 30;
      this.hit_dmg = this.basic_dmg * modificator.factor;
      this.dmg_levels = [];
      ...
      variants: [
        {
          ...
          func: function(wdata) {
            var ref;
            return (ref = wdata.dps) != null ? ref.toFixed(3) : void 0;
          }
        },
        {
          name: 'acc',
    ...
    return {
      ...
      update_damage: function(update = 'all') {
        ...
        return svgs.selectAll('rect.shot').data(function(wdata) {
          return wdata.shots;
        }).transition().duration(400).attrs(this.shot_attrs);
      }
    };
  })();
  ...
  hero_filter = (function() {
    ...
    toggleSelect = d3.selectAll('.nav-toggle-select').on("click", function() {
      ...
      if (toggle) {
        ...
        hero_selection_el.transition().style('height', h);
      } else {
        h = hero_selection_el.style('height');
        hero_selection_el.style('height', h);
        hero_selection_el.transition().duration(200).style('height', "0px");
      }
